...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `fabric/26.1.x` | `26.1.x` | `v26.1.2-0.2.2-fabric` | `25` | `0.19.2+` | `0.149.0+26.1.2` | `5.5+` | `26.1.4+` |
| `fabric/26.2.x` | `26.2.x` | `v26.2.0-0.1.1-fabric` | `25` | `0.19.3+` | `0.154.0+26.2` | `5.5.3+` | `26.2.1+` |
...
- `fabric/26.1.x`: `v26.1.2-0.2.2-fabric`
- `fabric/26.2.x`: `v26.2.0-0.1.1-fabric`
