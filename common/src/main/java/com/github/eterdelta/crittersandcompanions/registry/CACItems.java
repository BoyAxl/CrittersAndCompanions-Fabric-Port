...
public class CACItems {
    ...
    public static final RegistryEntry<Item> DUMBO_OCTOPUS_SPAWN_EGG = ITEMS.register("dumbo_octopus_spawn_egg", () -> Services.PLATFORM.createSpawnEgg(CACEntities.DUMBO_OCTOPUS, 0xFCDC4C, 0x162630, (new Item.Properties())));
    public static final RegistryEntry<Item> JUMPING_SPIDER_SPAWN_EGG = ITEMS.register("jumping_spider_spawn_egg", () -> Services.PLATFORM.createSpawnEgg(CACEntities.JUMPING_SPIDER, 0x34191E, 0x865F33, (new Item.Properties())));
    public static final RegistryEntry<Item> KOI_FISH_SPAWN_EGG = ITEMS.register("koi_fish_spawn_egg", () -> Services.PLATFORM.createSpawnEgg(CACEntities.KOI_FISH, 0xF3ECED, 0xFB5321, (new Item.Properties())));
    public static final RegistryEntry<Item> LEAF_INSECT_SPAWN_EGG = ITEMS.register("leaf_insect_spawn_egg", () -> Services.PLATFORM.createSpawnEgg(CACEntities.LEAF_INSECT, 0xDAD475, 0x3C6C34, (new Item.Properties())));
    public static final RegistryEntry<Item> OTTER_SPAWN_EGG = ITEMS.register("otter_spawn_egg", () -> Services.PLATFORM.createSpawnEgg(CACEntities.OTTER, 0x352C34, 0xB49494, (new Item.Properties())));
    public static final RegistryEntry<Item> RED_PANDA_SPAWN_EGG = ITEMS.register("red_panda_spawn_egg", () -> Services.PLATFORM.createSpawnEgg(CACEntities.RED_PANDA, 0xF4943C, 0x13131B, (new Item.Properties())));
    public static final RegistryEntry<Item> SEA_BUNNY_SPAWN_EGG = ITEMS.register("sea_bunny_spawn_egg", () -> Services.PLATFORM.createSpawnEgg(CACEntities.SEA_BUNNY, 0xF4ECE4, 0x453337, (new Item.Properties())));
    public static final RegistryEntry<Item> SHIMA_ENAGA_SPAWN_EGG = ITEMS.register("shima_enaga_spawn_egg", () -> Services.PLATFORM.createSpawnEgg(CACEntities.SHIMA_ENAGA, 0xFCFCEC, 0x5C3C34, (new Item.Properties())));
